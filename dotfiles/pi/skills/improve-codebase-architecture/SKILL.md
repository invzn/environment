...
Then delegate to the `repo-expert` agent (via the subagent tool) to walk the codebase. Don't follow rigid heuristics — explore organically and note where you experience friction:
