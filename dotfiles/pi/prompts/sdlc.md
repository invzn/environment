...
Drive each stage using its prompt's logic, delegating to subagents as those prompts specify. Present each stage's output and the record section it filled, then **wait for my go-ahead** before the next stage.
