...
- `~/.pi/agent/references/rust-styleguide.md` — Rust conventions for both test and production code
...
- Test through public interfaces only — never assert on private functions, internal call counts, or implementation details. See `~/.pi/agent/skills/tdd/tests.md`.
