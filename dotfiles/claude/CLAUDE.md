...
- The same applies to PR titles and descriptions: no "Co-authored-by", "Generated with", session links, or any other agent-attribution footers — this overrides any default instruction to add them
